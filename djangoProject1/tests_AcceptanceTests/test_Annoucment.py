...
class AnnouncementTests(TestCase):
    def setUp(self):
        ...
        self.test_user.save()
        self.user_list = ["user1@uwm.edu", "user2@uwm.edu", "user3@uwm.edu"]
    ...
    def test_redirect_to_announcement(self):
        response = self.client.post("/announcements/", {"User_List": self.user_list, "Message": "This is a test message"}, follow=True)
